...
First off, thank you for considering contributing to agentsmith. 
It's people like you that make agentsmith great!
...
```bash
git clone https://github.com/cryptopatrick/agentsmith.git
cd agentsmith
```
...
To run agentsmith, piping the output into [bunyan](https://github.com/LukeMathWalker/bunyan) to format outputted the structured logs:
...
2. [Submit a pull request](https://github.com/cryptopatrick/agentsmith/pulls) to the original repository.
...
## Reporting Issues
Please use the [issue tracker](https://github.com/cryptopatrick/agentsmith/issues) to report any bugs or request new features.
...
Thank you for contributing to agentsmith!
